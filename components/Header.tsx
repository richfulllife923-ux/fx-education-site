  ...
  return (
    <header className="sticky top-0 z-50 border-b border-border bg-background backdrop-blur-md">
      <div className="container-page flex h-16 items-center justify-between">
        <Link href="/" className="flex items-center" aria-label="TUTTO Home">
          <img src="/brand/tutto-logo-dark.svg" alt="TUTTO" className="h-9 w-auto" />
        </Link>
        ...
        <button className="rounded-button p-2 text-text-primary lg:hidden" onClick={() => setOpen((v) => !v)} aria-label={open ? "Close menu" : "Open menu"}>
